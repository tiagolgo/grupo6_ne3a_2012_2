...
//        configurações();
    ...
    private void initComponents() {
        ...
        tabelaCancelamento.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Disciplina", "Série", "Curso", "Turno", "CH", "Cancelar"
            }
        ) {
    ...
    private void verificaSeleção() {
        int linhas = this.tabelaCancelamento.getRowCount();
        ArrayList cancelamento = new ArrayList();
        for (int i = 0; i < linhas; i++) {
            if (this.tabelaCancelamento.getValueAt(i, 5) == true) {
                int s = this.tabelaCancelamento.getSelectedRow();
...
//        this.professor.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cancelamento_Tela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
