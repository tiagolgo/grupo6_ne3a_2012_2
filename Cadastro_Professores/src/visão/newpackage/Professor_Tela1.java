 ...
 */
public class Professor_Tela1 extends javax.swing.JFrame {
    ...
    public Professor_Tela1(Object obj, Session sessao) {
        this.sessão = sessao;
        auxConstrutor();
    ...
    private void preencheCampos(Professor pf) {
        ...
        this.número.setText(String.valueOf(pf.getEndereco().getNumero()));
        this.bairro.setText(pf.getEndereco().getBairro());
        this.municipio.setSelectedItem(pf.getEndereco().getMunicipio());
        this.uf_Endereco.setSelectedItem(pf.getEndereco().getEstado());
        this.cep.setText(pf.getEndereco().getCep());
        
        this.fone_Com.setText(String.valueOf(pf.getTelefone().get(0).getDdd()));
        this.fone_Com.setText(String.valueOf(pf.getTelefone().get(0).getNumero()));
    }
