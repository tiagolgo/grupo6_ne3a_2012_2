...
// Dao_Substituicao ds=new Dao_Substituicao(new Sessão().retornaSession());
// Dao_Afastamento da=new Dao_Afastamento(sessão);
        Dao_Professor d = new Dao_Professor(new Sessão().retornaSession());
//        Dao_Matriz dm=new Dao_Matriz(new Sessão().retornaSession());
